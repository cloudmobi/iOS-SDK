...
1. 添加CTSDK
- 使用 Cocoapod (1)将以下代码行添加到项目的 Podfile 文件中：pod 'CTSDK' (2)运行 pod install 命令。
- 手动下载SDK 将[CloudMobi iOS SDK](https://github.com/cloudmobi/iOS-SDK/raw/master/(CT)iOS-SDK.zip)下载解压之后将 CTSDK.framework 放到 Frameworks 下的 Xcode 中。
